...
#
# Sex-stratified cognitive eye-tracking analyses.
#
# Models use the same specification as the primary analysis, except that child
# sex is omitted from the covariate set within each sex stratum. Nominal p-values
# are reported, with significance assessed against the same outcome-specific
# Meff threshold used for the corresponding exposure hypothesis family.
# ==============================================================================
        ...
        purrr::map_dfr(
          ...
          function(outcome) {
            ...
            fit_linear_model(
              ...
              outcome = outcome,
              exposure = exposure,
              factor_covars = factor_covariates_stratified
            ) |>
              dplyr::mutate(
...
output_file <- file.path(
  results_dir,
  "04_cognitive_sex_stratified_analysis.xlsx"
)
...
message("Sex-stratified cognitive analysis completed.")
